...
#Added by massyl to fix byon vagrant installation

echo ''                             | sudo tee -a /etc/ssh/ssh_config 
echo '# Disable host verification'  | sudo tee -a /etc/ssh/ssh_config 
echo 'UserKnownHostsFile=/dev/null' | sudo tee -a /etc/ssh/ssh_config 
echo 'StrictHostKeyChecking=no'     | sudo tee -a /etc/ssh/ssh_config

echo '# No passord for vagrant' | sudo tee -a /etc/sudoers
